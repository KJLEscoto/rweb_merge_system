...
class TopRevisionController extends Controller
{
    public function index()
    {
        ...
        return view('admin.smm.topmanager.revision.index', compact('job_drafts'));
    }

    public function show($id)
    {
        $job_draft = JobDraft::with('jobOrder', 'contentWriter', 'graphicDesigner', 'client', 'revisions')->find($id);
        return view('admin.smm.topmanager.revision.show', compact('job_draft'));
    }

    public function edit($id)
    {
        $job_draft = JobDraft::with('jobOrder', 'contentWriter', 'graphicDesigner', 'client', 'revisions')->find($id);
        return view('admin.smm.topmanager.revision.edit', compact('job_draft'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $request = new Request([
            ...
            'to_user_id' => ['content' => Revision::where('id', $job_draft->id)->first()->declined_by], // for multiple users
