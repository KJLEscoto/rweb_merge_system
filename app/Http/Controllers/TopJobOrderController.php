...
class TopJobOrderController extends Controller
{
    public function index()
    {
        ...
        return view('admin.smm.topmanager.job_order.index', compact('supervisor_requests'));
    }

    public function create()
    {
        $operators = User::where('role_id', 2)->get();
        return view('admin.smm.topmanager.job_order.create', compact('operators'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.smm.topmanager.joborder')->with('Status', 'Job Order Created Successfully');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.smm.topmanager.job_order.show', compact('supervisor_request', 'job_order'));
    }
    ...
    public function edit($id)
    {
        $supervisor_request = ModelsRequest::with('issuer', 'assignee')->find($id);
        $operators = User::where('role_id', 2)->get();
        return view('admin.smm.topmanager.job_order.edit', compact('supervisor_request', 'operators'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.smm.topmanager.joborder')->with('Status', 'Job Order Updated Successfully');
    }
