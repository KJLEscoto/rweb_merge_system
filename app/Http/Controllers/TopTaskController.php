...
class TopTaskController extends Controller
{
    public function index()
    {
        ...
        return view('admin.smm.task.list', compact('job_drafts'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.smm.task.show', compact('job_draft'));
    }
    ...
    public function create($id)
    {
        ...
        // Pass both the job draft and the latest job draft to the view
        return view('admin.smm.task.create', compact('job_draft'));
    }
    ...
    public function store(Request $request, $id)
    {
        ...
        return redirect()->route('admin.smm.task')->with('Status', 'Draft Created Successfully');
    }
    ...
    public function edit($id)
    {
        ...
        // Pass both the job draft and the latest job draft to the view
        return view('admin.smm.task.edit', compact('job_draft'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.smm.task')->with('Status', 'Draft Updated Successfully');
    }

    public function accept($id)
    {
        if (!auth()->user()->signature) {
            return redirect()->route('admin.smm.task')->with('Status', 'No Signature Found');
        }
        ...
        return redirect()->route('admin.smm.task')->with('Status', 'Job Order Accepted Successfully');
    }
}
