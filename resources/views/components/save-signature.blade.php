...
<div id="signatureModal" class="fixed inset-0 flex items-center justify-center z-50 hidden">
    ...
    <div class="bg-white p-6 rounded z-10 max-w-md mx-auto">
        ...
        <div class="flex mb-4">
            <button type="button" id="drawSignatureToggle" class="mr-2 px-4 py-2 bg-blue-500 text-white rounded">Draw
                Signature</button>
            <button type="button" id="uploadSignatureToggle" class="px-4 py-2 bg-blue-500 text-white rounded">Upload
                Signature</button>
        </div>
        ...
        <div id="uploadSignatureContainer" class="hidden">
            <input type="file" name="uploadSignatureInput" id="uploadSignatureInput" accept="image/*">
            <img id="uploadedSignaturePreview" src="" alt="Uploaded Signature"
                class="mt-2 w-full border border-gray-400" style="display:none; height:200px;">
        </div>
