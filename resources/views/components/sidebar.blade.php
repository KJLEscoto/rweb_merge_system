...
@props(['link' => $user->roles->position])

<div class="space-y-4 z-10 h-full">
    @if ($link === 'assistant_supervisor')
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/dashboard') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('dashboard', 'dashboard/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/operation/task') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('operation/task', 'operation/task/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-file text-sm" style="color: #ffffff;"></i>
                </div>
                <div class="flex justify-between w-full">
                    <p class="block">My Tasks</p>
                    <p
                        class="mr-10 text-[.8rem] py-1 text-white px-2 rounded-lg bg-red-600 {{ $operationTaskCountContent + $operationTaskCountGraphic < 1 ? 'hidden' : '' }}">
                        {{ $operationTaskCountContent + $operationTaskCountGraphic }}</p>
                </div>
            </a>
        </div>
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/operation/requests') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('operation/requests', 'operation/request/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-code-pull-request text-sm" style="color: #ffffff;"></i>
                </div>
                <div class="flex justify-between w-full">
                    <p class="block">Incoming Requests</p>
                    <p
                        class="mr-10 text-[.8rem] py-1 text-white px-2 rounded-lg bg-red-600 {{ $operationIncomingRequestCount < 1 ? 'hidden' : '' }}">
                        {{ $operationIncomingRequestCount }}</p>
                </div>
            </a>
        </div>
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/joborder') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('joborder', 'joborder/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/operation') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('operation', 'operation/show/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-list-check text-sm" style="color: #ffffff;"></i>
                </div>
                <div class="flex justify-between w-full">
                    <p class="block">Approvals</p>
                    <p
                        class="mr-10 text-[.8rem] py-1 text-white px-2 rounded-lg bg-red-600 {{ $operationApprovalCount < 1 ? 'hidden' : '' }}">
                        {{ $operationApprovalCount }}</p>
                </div>
            </a>
        </div>
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/revision') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('revision', 'revision/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-pencil-alt text-sm" style="color: #ffffff;"></i>
                </div>
                <div class="flex justify-between w-full">
                    <p class="block">My Revisions</p>
                    <p
                        class="mr-10 text-[.8rem] py-1 text-white px-2 rounded-lg bg-red-600 {{ $revisionCount < 1 ? 'hidden' : '' }}">
                        {{ $revisionCount }}</p>
                </div>
            </a>
        </div>
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/operation/renewal') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('operation/renewal', 'operation/renewal/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/track') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('track', 'track/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/profile/show') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('profile', 'profile/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/users') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('users', 'register', 'users/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/operation/history') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('operation/history', 'operation/history/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
    ...
    @elseif ($link === 'client')
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/client') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('client', 'client/show/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-list-check text-sm" style="color: #ffffff;"></i>
                </div>
                <div class="flex justify-between w-full">
                    <p class="block">Approvals</p>
                    <p
                        class="mr-10 text-[.8rem] py-1 text-white px-2 rounded-lg bg-red-600 {{ $clientDraftCount < 1 ? 'hidden' : '' }}">
                        {{ $clientDraftCount }}</p>
                </div>
            </a>
        </div>
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/client/history') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('client/history', 'client/history/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-download text-sm" style="color: #ffffff;"></i>
                </div>
                <h1 class="block">Downloadables</h1>
            </a>
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/client/renewal') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('client/renewal', 'client/renewal/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-sync-alt text-sm" style="color: #ffffff;"></i>
                </div>
                <h1 class="block">Renewal</h1>
            </a>
    ...
    @elseif ($link === 'content_writer')
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/content') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('content', 'content/edit/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-file text-sm" style="color: #ffffff;"></i>
                </div>
                <div class="flex justify-between w-full">
                    <p class="block">My Tasks</p>
                    <p
                        class="mr-10 text-[.8rem] py-1 text-white px-2 rounded-lg bg-red-600 {{ $contentDraftCount < 1 ? 'hidden' : '' }}">
                        {{ $contentDraftCount }}</p>
                </div>
            </a>
        </div>
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/revision') }}"
                ...
                <div class="flex justify-between w-full">
                    <p class="block">My Revisions</p>
                    <p
                        class="mr-10 text-[.8rem] py-1 text-white px-2 rounded-lg bg-red-600 {{ $contentRevisionCount < 1 ? 'hidden' : '' }}">
                        {{ $contentRevisionCount }}</p>
                </div>
            </a>
        </div>

        <div class="block px-6">
            <a href="{{ url('/admin/smm/content/history') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('content/history', 'content/history/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-download text-sm" style="color: #ffffff;"></i>
                </div>
                <h1 class="block">Downloadables</h1>
            </a>
    ...
    @elseif ($link === 'graphic_designer')
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/graphic') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('graphic', 'graphic') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-file text-sm" style="color: #ffffff;"></i>
                </div>
                <div class="flex justify-between w-full">
                    <p class="block">My Tasks</p>
                    <p
                        class="mr-10 text-[.8rem] py-1 text-white px-2 rounded-lg bg-red-600 {{ $graphicDraftCount < 1 ? 'hidden' : '' }}">
                        {{ $graphicDraftCount }}</p>
                </div>
            </a>
        </div>
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/revision') }}"
                ...
                <div class="flex justify-between w-full">
                    <p class="block">My Revisions</p>
                    <p
                        class="mr-10 text-[.8rem] py-1 text-white px-2 rounded-lg bg-red-600 {{ $graphicRevisionCount < 1 ? 'hidden' : '' }}">
                        {{ $graphicRevisionCount }}</p>
                </div>
            </a>
        </div>

        <div class="block px-6">
            <a href="{{ url('/admin/smm/graphic/history') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('graphic/history', 'graphic/history/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-download text-sm" style="color: #ffffff;"></i>
                </div>
                <h1 class="block">Downloadables</h1>
            </a>
    ...
    @elseif ($link === 'top_manager')
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/topmanager') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('topmanager', 'topmanager/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-list-check text-sm" style="color: #ffffff;"></i>
                </div>
                <div class="flex justify-between w-full">
                    <p class="block">Approval</p>
                    <p
                        class="mr-10 text-[.8rem] py-1 text-white px-2 rounded-lg bg-red-600 {{ $topmanagerApprovalCount < 1 ? 'hidden' : '' }}">
                        {{ $topmanagerApprovalCount }}</p>
                </div>
            </a>
        </div>
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/requestForm/history') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('requestForm/create', 'requestForm/history', 'requestForm/create/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/users') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('users', 'users/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-user-plus text-sm" style="color: #ffffff;"></i>
                </div>
                <h1 class="block">Users</h1>
            </a>
    ...
    @elseif ($link == 'supervisor')
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/supervisor/joborder') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('supervisor/joborder', 'supervisor/joborder/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-code-pull-request text-sm"
                        style="color: #ffffff; transform: scaleY(-1);"></i>
                </div>
                <div class="flex justify-between w-full">
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/supervisor/directjob') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('supervisor/directjob', 'supervisor/directjob/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/supervisor/task') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('supervisor/task', 'supervisor/task/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-file text-sm" style="color: #ffffff;"></i>
                </div>
                <div class="flex justify-between w-full">
                    <p class="block">My Tasks</p>
                    <p
                        class="mr-10 text-[.8rem] py-1 text-white px-2 rounded-lg bg-red-600 {{ $supervisorTaskCountContent + $supervisorTaskCountGraphic < 1 ? 'hidden' : '' }}">
                        {{ $supervisorTaskCountContent + $supervisorTaskCountGraphic }}</p>
                </div>
            </a>
        </div>
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/supervisor/approve') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('supervisor/approve', 'supervisor/approve/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-list-check text-sm" style="color: #ffffff;"></i>
                </div>
                <div class="flex justify-between w-full">
                    <p class="block">Approvals</p>
                    <p
                        class="mr-10 text-[.8rem] py-1 text-white px-2 rounded-lg bg-red-600 {{ $supervisorApprovalCount < 1 ? 'hidden' : '' }}">
                        {{ $supervisorApprovalCount }}</p>
                </div>
            </a>
        </div>
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/supervisor/renewal') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('supervisor/renewal', 'supervisor/renewal/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-sync-alt text-sm" style="color: #ffffff;"></i>
                </div>
                <h1 class="block">Renewal</h1>
            </a>
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/requestForm/create') }}"
                class="p-2 flex items-center w-full gap-2 rounded-md {{ request()->is('requestForm/create', 'requestForm/history', 'requestForm/create/*') ? 'bg-[#f68e12] text-white font-bold' : 'hover:bg-gray-200 transition-all' }}"
                style="{{ request()->is('requestForm/create', 'requestForm/history', 'requestForm/create/*') ? 'box-shadow: 0 1px 10px rgba(0, 0, 0, 0.6);' : '' }}">
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('requestForm/create', 'requestForm/history', 'requestForm/create/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
        ...
        <div class="block px-6">
            <a href="{{ url('/admin/smm/supervisor/history') }}"
                ...
                <div
                    class="size-10 flex items-center justify-center rounded-lg {{ request()->is('supervisor/history', 'supervisor/history/*') ? 'bg-black' : 'bg-[#f66d11]' }}">
                    <i class="fa-solid fa-download text-sm" style="color: #ffffff;"></i>
                </div>
                <h1 class="block">Downloadables</h1>
            </a>
