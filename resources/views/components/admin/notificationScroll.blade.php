<script>
    ...
    function appendNotification(notificationData, containerId, tabId) {
        ...
        notificationDiv.className = `flex items-center justify-between gap-5 p-3 w-full cursor-pointer hover:bg-gray-50 ${parseInt(notificationData.is_read) ? "bg-white" : "bg-gray-100"
            }`;
