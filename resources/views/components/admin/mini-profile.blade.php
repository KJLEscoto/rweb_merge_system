    ...
    <section class="flex items-center gap-2">
        <div class="dropdown relative inline-flex self-center">
            ...
            <div id="dropdown-show-notification"
                ...
                <section id="tab-content-unread" class="divide-y divide-gray-100 w-full h-60 overflow-auto"
                ...
                <section id="tab-content-archived" class="divide-y divide-gray-100 w-full h-60 overflow-auto"
