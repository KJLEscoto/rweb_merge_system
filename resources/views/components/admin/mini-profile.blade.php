    ...
    <section class="flex items-center gap-2">
        <div class="dropdown relative inline-flex self-center">
            ...
            <div id="dropdown-show-notification"
                ...
                <section class="flex justify-center items-center p-3 text-[#F57D11]">
                    <div class="">
                        <button id="see-all" class="" onclick="">
                            See All
                        </button>
                    </div>
                </section>
                ...
                <section id="tab-content-all"
                    class="divide-y divide-gray-100 w-full h-[8rem] sm:h-[10rem] md:h-[12rem] lg:h-[14rem] xl:h-[24rem] overflow-auto overflow-x-hidden"
                                ...
                                <div class="w-auto h-auto">
                                    <div class="w-10 h-10 rounded-full border border-[#F57D11] overflow-hidden">
                                        <img id="all-notification-image-profile"
                                            src="{{ $notification->file_path ? asset($notification->file_path) : asset('resources/img/default-male.png') }}"
                                            class="w-full h-full" />
                                    </div>
                                </div>
                ...
                <section id="tab-content-unread"
                    class="divide-y divide-gray-100 w-full h-[15rem] sm:h-[17rem] md:h-[16rem] lg:h-[20rem] xl:h-[45rem] overflow-auto overflow-x-hidden"
    ...
    <div class="dropdown relative inline-flex hover:scale-105 transition">
        <span class="group">
            <button type="button" id="dropdown-profile" data-target="dropdown-show-profile"
                ...
                <img draggable="false" src="{{ asset(\App\Models\File::where(
    'id',
    \App\Models\Profile::where('id', Auth::user()->profile_id)->first()->file_id
)->first()->path) }}" alt="user profile"
...
@include('components.admin.profileModalDropDown')
@include('components.admin.notifcations')
@include('components.admin.notificationScroll')
@include('components.admin.notificationClickEvent')