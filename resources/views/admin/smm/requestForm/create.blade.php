<head>
    <title>{{ env('APP_NAME') }} | SMM | Create Request Form</title>
...
<x-main-layout breadcumb="SMM / History Request Form" page="Create Request Form">
                    ...
                    <tr>
                        <td><strong>Particulars:</strong><br>
                            ...
                            <label><input type="checkbox" name="particulars[]" value="Domain"
                                    {{ in_array('Domain', $selectedParticulars) ? 'checked' : '' }}> Domain</label><br>
                            ...
                            <label><input type="checkbox" name="particulars[]" value="Flyers"
                                    {{ in_array('Flyers', $selectedParticulars) ? 'checked' : '' }}> Flyers</label><br>
                        </td>
                        <td>
                            <label><input type="checkbox" name="particulars[]" value="for Multimedia Use"
                                    {{ in_array('for Multimedia Use', $selectedParticulars) ? 'checked' : '' }}> for
                                Multimedia Use</label><br>
                            ...
                            <label><input type="checkbox" name="particulars[]" value="Refund"
                                    {{ in_array('Refund', $selectedParticulars) ? 'checked' : '' }}> Refund</label><br>
                            <label>
...
<div id="description-modal" class="fixed inset-0 z-50 bg-black bg-opacity-50 hidden flex items-center justify-center">
    <div class="bg-white p-6 rounded-lg shadow-lg w-1/2">
        <form id="description-form" action="{{ url('admin/smm/requestForm/store') }}" method="POST">
            @csrf
            <div class="h-40 overflow-y-auto">
                <label><input type="checkbox" name="particulars[]" value="Domain"> Domain</label><br>
                <label><input type="checkbox" name="particulars[]" value="Hosting and Servers"> Hosting and
                    Servers</label><br>
                <label><input type="checkbox" name="particulars[]" value="Office Supplies"> Office
                    Supplies</label><br>
                ...
                <label><input type="checkbox" name="particulars[]" value="Office Asset / Cash Advance"> Office Asset
                    / Cash Advance</label><br>
                ...
                <label><input type="checkbox" name="particulars[]" value="for Multimedia Use"> for Multimedia
                    Use</label><br>
                ...
                <label><input type="checkbox" name="particulars[]" value="For Marketing Use"> For Marketing
                    Use</label><br>
                <label><input type="checkbox" name="particulars[]" value="Ads - AUB"> Ads - AUB</label><br>
                <label><input type="checkbox" name="particulars[]" value="Repair and Maintenance"> Repair and
