<head>
    <title>{{ env('APP_NAME') }} | SMM | Job Order Edit</title>
...
<x-main-layout breadcumb="SMM / Outgoing Requests" page="Job Order Edit">
    <div class="px-10 pt-10">
        <div class="w-full px-6 py-10 mx-auto rounded-lg custom-shadow bg-white">
            ...
            <form action="{{ url('/admin/smm/joborder/update/' . $job_draft->id) }}" method="POST">
                @csrf
                @method('PUT')
                            ...
                            <div class="w-full col-span-2 lg:col-span-1">
                                ...
                                <div class="relative">
                                    <input type="text" id="selected-graphic-designer-name"
                                        ...
                                        readonly onclick="openGraphicDesignerModal()">
                            ...
                            <div class="w-full col-span-2 lg:col-span-1">
                                ...
                                <div class="relative">
                                    <input type="text" id="selected-content-writer-name"
                                        ...
                                        class="w-full border px-3 py-2  border-gray-200 rounded-lg cursor-pointer"
                                        readonly onclick="openContentWriterModal()">
                            ...
                            <div class="col-span-2 lg:col-span-1 grid grid-cols-2 w-full gap-4 rounded-lg">
                                <div>
                                    ...
                                    <input type="date" name="date_started"
                                        class="w-full rounded-lg border px-3 py-2  border-gray-200"
                                        value="{{ old('date_started', \Carbon\Carbon::parse($job_draft->date_started)->format('Y-m-d')) }}">
                                    @error('date_started')
                                        <p class="text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="date" name="date_target"
                                        class="w-full rounded-lg border px-3 py-2  border-gray-200"
                                        value="{{ old('date_target', \Carbon\Carbon::parse($job_draft->date_target)->format('Y-m-d')) }}">
                                    @error('date_target')
                                        <p class="text-red-600 text-sm">{{ $message }}</p>
                                    @enderror
                                </div>
        ...
        <div id="client-modal"
            ...
            <div class="bg-white w-full max-w-sm md:max-w-lg lg:max-w-2xl px-5 pb-10 pt-5 rounded-lg">
                <!-- Search & Close button -->
                <div
                    class="w-full flex md:flex-row justify-between items-center flex-col-reverse lg:flex-row gap-4 mb-4">
