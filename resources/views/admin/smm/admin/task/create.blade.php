...
<head>
    <title>{{ env('APP_NAME') }} | SMM | Task Create</title>
...
<x-main-layout breadcumb="SMM / My Task" page="Task Create">
    <div class="px-10 pt-10">
        <div class="w-full px-6 py-10 mx-auto rounded-lg bg-white custom-shadow">
            ...
            <form action="{{ url('/admin/smm/operation/task/store/' . $job_draft->id) }}" method="POST">
                @csrf
                @method('PUT')
