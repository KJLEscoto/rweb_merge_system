...
@php
    ...
    $backRoute = '';
    if (Auth::user()->roles->position == 'top_management') {
        $backRoute = route('admin.smm.topmanager.directjob');
        $storeRoute = route('admin.smm.topmanager.directjob.store');
    } elseif (Auth::user()->roles->position == 'operations_supervisor') {
        $backRoute = route('admin.smm.supervisor.directjob');
        $storeRoute = route('supervisor.directjob.store');
    }
@endphp
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function toggleInput(checkbox, input, modalFunctionName) {
            if (checkbox.checked) {
                ...
                input.onclick = window[modalFunctionName];
            } else {
                input.disabled = true;
