<head>
    <title>{{ env('APP_NAME') }} | SMM | Revision</title>
                ...
                @forelse ($job_drafts as $job_draft)
                    <tr class="project-row border-b">
                        ...
                        <td class="w-[20%] px-6 py-3 text-white text-center">
                            <p
                                class="w-full px-2 py-1 rounded-lg text-nowrap
                        ...
                        <td class="w-[20%] px-4 py-3">
                            <a
                                href="{{ $job_draft->status === 'Revision' ? url('admin/smm/revision/edit/' . $job_draft->id) : '#' }}">
                                <button
