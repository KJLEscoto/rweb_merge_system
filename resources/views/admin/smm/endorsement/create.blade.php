...
<x-main-layout breadcumb="SMM / Direct Job Order" page="Create Direct Job Order">
    ...
    <div class="w-full px-6 py-10 mx-auto rounded-lg custom-shadow bg-white">
        ...
        <form action="{{ route('admin.smm.endorsement.store') }}" method="POST">
            @csrf
            ...
            <div class="grid grid-cols-4 space-y-4">
                <div class="col-span-4 grid grid-cols-2 gap-4 mt-4">
                    ...
                    <div class="col-span-2 h-fit w-full">
                        ...
                        <!-- CKEditor Textarea -->
                        <textarea name="timeline" id="timeline" class="w-full border-gray-200 rounded-lg">{{ old('timeline') }}</textarea>
                        @error('timeline')
                            <p class="text-red-600 text-sm">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-2 h-fit w-full">
                        ...
                        <!-- CKEditor Textarea -->
                        <textarea name="deliverables" id="deliverables" class="w-full border-gray-200 rounded-lg">{{ old('deliverables') }}</textarea>
                        @error('deliverables')
                            <p class="text-red-600 text-sm">{{ $message }}</p>
                        @enderror
                    </div>
