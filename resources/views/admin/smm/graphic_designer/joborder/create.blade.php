<head>
    <title>{{ env('APP_NAME') }} | SMM | Graphic Create Job Order</title>
...
<x-main-layout breadcumb="SMM / List of Job Order" page="Graphic Create Job Order">
    ...
    <div class="w-full px-6 py-10 mx-auto rounded-lg bg-white custom-shadow">
        ...
        <form action="{{ url('smm/graphic/store/' . $job_draft->id) }}" method="POST">
            @csrf
            @method('PUT')
