        ...
        <div class="bg-white p-10 rounded-lg shadow-lg">
            <div class="">
                ...
                <div class="mt-5">
                    ...
                    <div class="border border-gray-400 p-3 rounded-lg max-h-[500px] overflow-y-auto">{!! $job_order->description !!}</div>
                </div>
            </div>
                ...
                <div class="overflow-x-auto overflow-y-auto bg-white shadow-md rounded-lg">
                    <table class="w-full text-left border-collapse min-w-full sm:min-w-max" id="projectTable">
                        <thead class="sticky top-0 bg-[#fa7011] text-white">
                            <tr>
                                <th class="px-2 sm:px-4 py-2 text-center md:text-left text-nowrap sm:py-3 text-xs sm:text-base">Type</th>
                                ...
                                <th class="px-2 sm:px-4 py-2 text-center text-nowrap sm:py-3 text-xs sm:text-base">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
