                ...
                <div class="col-span-4 grid grid-cols-2 gap-4 mt-4">
                    <div class="col-span-4 grid grid-cols-4">
                        ...
                        <div class="col-span-4 lg:col-span-1 w-full">
                            ...
                            <p class="text-xl">{{ \Carbon\Carbon::parse($job_draft->date_target)->format('Y-m-d') }}
                            </p>
                        </div>
                    </div>
