<head>
    <title>{{ env('APP_NAME') }} | SMM | Create Job Oder</title>
...
<x-main-layout breadcumb="SMM / List Job Order" page="Create Job Oder">
    ...
    <div class="w-full px-6 py-10 mx-auto rounded-lg bg-white custom-shadow">
        ...
        <form action="{{ url('smm/content/store/' . $job_draft->id) }}" method="POST">
            @csrf
            @method('PUT')
