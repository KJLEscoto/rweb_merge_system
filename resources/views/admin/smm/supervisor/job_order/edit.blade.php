<head>
    <title>{{ env('APP_NAME') }} | SMM | Edit Job Order</title>
...
<x-main-layout breadcumb="SMM/ Job Order" page="Edit Job Order">
                ...
                <div class="col-span-4 grid grid-cols-2 gap-4 mt-4">
                    <div class="col-span-2 lg:col-span-1 w-full">
                        ...
                        <input type="text" name="title" class="w-full border px-3 py-2  border-gray-200 rounded-lg"
                            value="{{ old('title', $supervisor_request->title) }}">
                        @error('title')
                    ...
                    <div class="col-span-2 lg:col-span-1 grid grid-cols-2 gap-4 w-full">
                        ...
                        <div>
                            ...
                            <input type="date" name="deadline" value={{ $supervisor_request->deadline }}
