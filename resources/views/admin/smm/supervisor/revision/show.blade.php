        ...
        <div class="w-full px-6 py-10 mx-auto rounded-lg custom-shadow bg-white">
            ...
            <div class="mt-4 grid grid-cols-4">
                ...
                <div class="col-span-4 h-fit">
                    ...
                    <!-- Quill Editor -->
                    <div id="quill-editor"
                        class="w-full border-gray-200 rounded-lg custom-shadow custom-focus-ring min-h-fit max-h-[500px] overflow-y-auto">
                        {!! json_encode($job_draft->jobOrder->description) !!}</div>
