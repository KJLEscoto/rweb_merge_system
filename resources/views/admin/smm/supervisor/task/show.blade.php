<head>
    <title>{{ env('APP_NAME') }} | SMM | Show Supervisor Task</title>
...
<x-main-layout breadcumb="SMM / List Supervisor Task" page="Show Supervisor Task">

    <div id="container-pdf">
        <div class="bg-[#fa7011] text-white rounded-md px-3 py-1 w-fit mb-4">
            <a href="{{ url('/admin/smm/supervisor/task') }}">Back</a>
        </div>
        <div class="header">
