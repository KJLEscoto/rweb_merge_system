    ...
    <div class="h-auto">
        <div class=" text-white">
            <div class="w-full flex justify-end items-end mb-4 cursor-pointer"
                onclick="window.location.assign('{{ url('admin/smm/profile/show') }}')">
                <div class="w-fit px-4 py-1 bg-[#f68e12] rounded-md">Go Back</div>
            </div>

            <form action="{{ url('admin/smm/profile/update/') }}" method="POST" enctype="multipart/form-data"
                id="userForm">
                @csrf
                @method('PATCH')
                ...
                <div class="grid grid-cols-3 h-auto gap-6 text-black">
                    <div class="space-y-10 col-span-3 lg:col-span-1">
                        ...
                        <div class="px-10 col-span-3 w-full lg:col-span-3 bg-white shadow-md rounded-md pt-10 py-10">
                            ...
                            <div id="padSection" class="hidden mt-4">
                                <canvas id="signature-pad" class="w-full col-span-1 border-2 border-red-400"
                    ...
                    <div
                        class="col-span-3 lg:col-span-2 bg-white shadow-md h-fit rounded-md p-5 border border-[#e1e1e1]">
                        ...
                        <div class="gap-4 items-center">
                            ...
                            <input type="password" name="password"
                                class="pl-4 w-full border rounded-md py-1 border-[#e1e1e1]">
                            @error('password')
                                <p class="text-sm text-red-700">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="pt-4">
                            <button type="submit"
                                class="px-4 py-1 bg-[#f68e12] w-fit cursor-pointer text-white">Update</button>
                        </div>
                    </div>
                </div>
            </form>
        ...
        document.getElementById("userForm").addEventListener("submit", (event) => {
            ...
            if (!uploadSection.classList.contains("hidden")) {
                ...
                if (signaturePad.isEmpty()) {
                    ...
                    document.getElementById("signaturePadData").value = signaturePad.toDataURL(
                        "image/png");
                }
            }
