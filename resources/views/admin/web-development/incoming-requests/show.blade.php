<head>
    <title>{{ env('APP_NAME') }} | SMM | Incoming Request Show</title>
...
<x-main-layout breadcumb="Web Development / Incoming Request" page="Incoming Request Show">
        ...
        <div class="w-full px-6 py-10 mx-auto rounded-lg custom-shadow bg-white">
            ...
            <div id="container-pdf">
                <div class="header">
                    ...
                    <h2>{{ucwords($web_request->issued_by->name)}} Job Order Form</h2>
                </div>
                ...
                <div class="section">
                    ...
                    <table>
                        <tr>
                            <td><strong>Date Issued:</strong><br>
                                {{ $web_request->created_at ? \Carbon\Carbon::parse($web_request->created_at)->format('Y-m-d') : 'N/A' }}
                            </td>
                    ...
                    <table>
                        <tr>
                            <td><strong>Issued by:</strong><br>{{ $web_request->issued_by->name }}</td>
                            <td>
                                <strong>Work Performed by:</strong><br>
                                {{ $web_request->issued_to->name }}
                            </td>
                        </tr>
                    </table>
                    ...
                    <table>
                        <tr>
                            <td class="signature">
                                ...
                                @if ($web_request->status === 'Waiting for Operation Approval')
                            ...
                            <td class="signature">
                                <strong>Operations Supervisor Signature:
                                    {{ $web_request->issued_by->name }}</strong><br>
                                <img src="{{ asset($web_request->issued_by->signature) }}" alt="Supervisor Signature">
                            </td>
                        </tr>
                    </table>
                </div>
