...
<head>
    <title>{{ env('APP_NAME') }} | DTR | Dashboard</title>
...
<x-main-layout breadcumb="DTR" page="Dashboard">
    ...
    <div class="flex flex-col gap-5 w-auto h-auto px-16 pt-10">
        ...
        <div class="flex lg:flex-row flex-col lg:gap-7 gap-5 w-full lg:!h-[500px] h-[600px]">
            <section
                class="p-7 w-full border bg-white border-gray-200 shadow-md h-full overflow-hidden flex flex-col gap-3">
                <div class="flex lg:items-end items-center flex-wrap gap-2 justify-between w-full font-semibold">
                    <div class="flex lg:items-start items-center gap-2">
                        <p class="font-semibold lg:!text-base text-sm">Daily Attendance</p>
                    </div>
                                ...
                                <div class="h-auto w-auto">
                                    <div class="w-12 h-12 rounded-full border border-[#F57D11] overflow-hidden">
                                        <x-image className="w-full h-full"
                                            path="{{ \App\Models\File::where('id', $daily['profiles']['file_id'])->first()->path . '?t=' . time() }}" />
                                    </div>
                                </div>
            ...
            <section
                class="p-7 shadow-md border border-gray-200 bg-white h-full w-full overflow-hidden flex flex-col gap-3">
                <div class="flex lg:items-end items-center flex-wrap gap-2 justify-between w-full font-semibold">
                    <div class="flex lg:items-start items-center gap-2">
                        <p class="font-semibold lg:!text-base text-sm">Top 3 Performer</p>
                    </div>
                    <p class="md:!text-sm text-xs font-semibold text-red-500">Highest Hour Basis</p>
                </div>

                <!--HTML CODE-->
                <div class="w-full relative h-full border border-gray-200">
        ...
        <div class="grid grid-cols-2 gap-5 w-full h-auto">
            @foreach ($totals as $total)
                <section class="p-7 w-full flex justify-between h-full border bg-white border-gray-200 shadow-md">
        ...
        <div class="w-full h-full">
            <section class="p-7 w-full border bg-white border-gray-200 shadow-md h-[500px] flex flex-col gap-5">
                <div class="flex items-center gap-2 font-semibold">
                    <p class="font-semibold lg:!text-base text-sm">Recently Added Users</p>
                </div>
