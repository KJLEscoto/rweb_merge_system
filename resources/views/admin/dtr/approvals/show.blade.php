...
<x-main-layout breadcumb="DTR / Interns" page="View DTR">
    <main class="w-full">
        ...
        <div class="flex flex-col w-full items-center justify-center">
            <div
                class="w-full grid grid-cols-2 text-nowrap gap-5 bg-white p-3 border border-orange-300 shadow-lg sticky top-[125px] z-30 rounded max-w-screen-xl mx-auto">

                <section class="col-span-1 flex items-center justify-start">
                    <x-button routePath="admin.dtr.approvals" label="Back" tertiary button
                ...
                <section class="flex items-center gap-3 col-span-1 justify-end w-full h-auto">
                    <button name="approved_button"
                        class="approve-btn hover:bg-green-600 rounded lg:px-8 px-2 py-2 text-sm bg-green-500 text-white flex items-center justify-center gap-1">
                        <span class="uil--check w-6 h-6"></span>Approve
                    </button>

                    <button name="declined_button"
                        class="decline-btn hover:bg-red-600 rounded lg:px-8 px-2 py-2 text-sm bg-red-500 text-white flex items-center justify-center gap-1">
